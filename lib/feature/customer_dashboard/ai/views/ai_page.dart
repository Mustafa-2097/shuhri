      ...
      child: Column(
        children: [
          Row(
            children: [
              Container(
                ...
                child: Icon(Icons.auto_awesome_rounded, color: const Color(0xFF22C55E), size: 18.sp),
              ),
              SizedBox(width: 12.w),
              Expanded(
                child: Column(
          ...
          Container(
            ...
            child: Center(
              child: Icon(Icons.show_chart_rounded, color: const Color(0xFF2563EB).withOpacity(0.4), size: 48.sp),
            ),
          ),
        ],
      ),
